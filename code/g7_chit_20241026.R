...
library(writexl)
#path to data
gc <- here::here("data","g7_chit_20241026.xlsx")
...
initial <- here::here("data", "g7_chit_initialvalues_20241026.xlsx")
...
data_location2 <- here::here("data", "g7chit_clean_202410126.xlsx")
