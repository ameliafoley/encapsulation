...
input_file <- "Ames Assay Results 20260730 copy.xlsx"
output_dir <- "ames_outputs_72hr"
...
raw <- read_excel(here::here("data", "Ames Assay Results 20260730 copy.xlsx"))|> janitor::clean_names()
