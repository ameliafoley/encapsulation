...
library(ggpubr)
#path to data
gc <- here::here("data","f199_chit_20241031.xlsx")
...
initial <- here::here("data", "f199_chit_initialvalues_20241031.xlsx")
...
data_location2 <- here::here("data", "f199chit_clean_202410131.xlsx")
